...
<head>
    <meta charset="UTF-8">
    <title>Marine Meteorology Monitoring</title>
...
<div class="signup">
    ...
    <form id="signUpData" method="post" role="form" class="col-lg-4 col-lg-offset-1" style="border:1px solid #dcdcdc;">
        ...
        <div class="form-group">
            <input type="password" class="form-control" id="pwdCon" placeholder="Confirm Password" name="password2">
        </div>
        <div class="form-group">
            <button id="signUp" type="submit" class="btn btn-primary btn-block btn-large">Signup</button>
        </div>
    </form>
